...
- `audit`, `prepare`, `launch`, and `refresh` operating modes.
- Privacy/IP, portability, readiness, README, discovery, Repository Pulse, and
  adoption contracts.
- Deterministic public-surface auditor with redacted findings and optional
